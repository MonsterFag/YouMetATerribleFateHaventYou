...
namespace db
{
    public partial class Database : IDisposable
    {
        ...
        public Database()
        {
				const string serverDatabaserotmguidrootpasswordbotmakerPoolingtrueConnectionTimeoutMinimumPoolSizemaximumpoolsize = "Server=127.0.0.1;Database=rotmg;uid=root;password=botmaker;Pooling=true;Connection Timeout=60;MinimumPoolSize=5;maximumpoolsize=400;";
            	 _con = Testing
	               ? new MySqlConnection( /* Testing = true; */
                     "Server=127.0.0.1;Database=rotmg;uid=root;password=botmaker;Pooling=true;Connection Timeout=60;MinimumPoolSize=5;maximumpoolsize=400;")
	               : new MySqlConnection(/* Testing = false; */
				serverDatabaserotmguidrootpasswordbotmakerPoolingtrueConnectionTimeoutMinimumPoolSizemaximumpoolsize);
               _con.Open();
