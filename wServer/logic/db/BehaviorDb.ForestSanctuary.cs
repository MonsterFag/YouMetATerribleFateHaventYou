            ...
            .Init(0x700d, Behaves("Elder Tree",
                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(500, new LootDef(0, 5, 0, 10,
                        ...
                        Tuple.Create(0.03, (ILoot) new ItemLoot("Staff of Natural Essence")),
                        Tuple.Create(0.015, (ILoot) new ItemLoot("Void Incantation")),
                        Tuple.Create(0.03, (ILoot)new ItemLoot("Wine Cellar Incantation"))
                        )))
                ))
