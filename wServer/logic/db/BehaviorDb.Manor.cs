            ...
            .Init(0x1720, Behaves("Lord Ruthven",
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 2, 0, 2,
                            Tuple.Create(0.010, (ILoot)new ItemLoot("Wine Cellar Incantation")),
                            Tuple.Create(0.008, (ILoot)new ItemLoot("Tome of Purification")),
                            Tuple.Create(0.006, (ILoot)new ItemLoot("Draculas Sword")),
                            ...
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Ring of Divine Faith"))
                    )))
