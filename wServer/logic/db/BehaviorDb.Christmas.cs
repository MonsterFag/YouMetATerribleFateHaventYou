                ...
                new RunBehaviors(
                  ...
                  loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 5, 0, 15,
                            Tuple.Create(0.095, (ILoot)new ItemLoot("Christmas Blade")),
                            Tuple.Create(0.095, (ILoot)new ItemLoot("Tree Topper Star")),
                            Tuple.Create(0.095, (ILoot)new ItemLoot("Reindeer Skin Armor")),
                            Tuple.Create(0.095, (ILoot)new ItemLoot("Santa Hat")),
                            Tuple.Create(0.095, (ILoot)new ItemLoot("Christmas Miracle")),
