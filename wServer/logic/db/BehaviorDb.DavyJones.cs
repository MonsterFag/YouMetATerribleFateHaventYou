            ...
            new RunBehaviors(
                SimpleWandering.Instance(2, 5),
                       ...
                       Tuple.Create(100, new LootDef(0, 5, 0, 10,
                            Tuple.Create(0.001, (ILoot)new ItemLoot("Spirit Dagger")),
                            Tuple.Create(0.001, (ILoot)new ItemLoot("Spectral Cloth Armor")),
                            Tuple.Create(0.001, (ILoot)new ItemLoot("Ghostly Prism")),
                            Tuple.Create(0.99, (ILoot)new ItemLoot("Potion of Wisdom")),
                            Tuple.Create(0.001, (ILoot)new ItemLoot("Captain's Ring"))
                            ))
                        ))
