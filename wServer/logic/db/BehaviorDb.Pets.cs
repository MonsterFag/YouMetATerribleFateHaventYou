        ...
        private static _ Pets = Behav()
           ...
           .Init(0x6004, Behaves("Wverhe's Pet",
            ...
            .InitMany(0x6101, 0x61ff, i => Behaves("Donator Pet",
                new RunBehaviors(
                    ...
                    Cooldown.Instance(new GetTag(i).GetInt("MP", "Cooldown", 0),
                        ...
                        new IfTag("Shoot",
							...
							.Init(0x7136, Behaves("Real Lil' Oryx",
                new RunBehaviors(
                    If.Instance(new PetBehaves(), PetChasing.Instance(13, 8, 3)),
                    Cooldown.Instance(800, new PetsHealingHP(100, 200)),
                    Cooldown.Instance(800, new PetsHealingMP(100, 200)),
					Cooldown.Instance(3000, PetPredictiveMultiAttack.Instance(25, 36*(float) Math.PI/180, 10, 0, projectileIndex: 0)),
                     Cooldown.Instance(105000,
                        Rand.Instance(
                            new RandomTaunt(1.1, "You should be following ME!"),
                            new RandomTaunt(4.9, "Bledixon is the most powerful being in the universe!"),
              ...
              .Init(0x7162, Behaves("Lil' Malphas Son",
                new RunBehaviors(
               If.Instance(new PetBehaves(), PetChasing.Instance(10, 10, 3)),
               Cooldown.Instance(1500, new PetsHealingHP(69, 69)),
               Cooldown.Instance(1500, new PetsHealingMP(33, 33))
              ...
              .Init(0x7160, Behaves("Lil' Gender",
                new RunBehaviors(
               If.Instance(new PetBehaves(), PetChasing.Instance(10, 10, 3)),
               Cooldown.Instance(1500, new PetsHealingHP(69, 69)),
               Cooldown.Instance(1500, new PetsHealingMP(33, 33))
        	...
        	.Init(0x7166, Behaves("Kirbyy",
                new RunBehaviors(
                    ...
                    Cooldown.Instance(800, new PetsHealingMP(200, 200)),
                     Cooldown.Instance(105000,
                        Rand.Instance(
                            new RandomTaunt(1.1, "Kieronator is sexy as hell!"),
                            new RandomTaunt(4.9, "Bledixon is still the most powerful being in the universe!"),
                            new RandomTaunt(1.1, "I am the most powerful character in the universe!"),
                            new RandomTaunt(1.01, "Saw my Brother?"),
