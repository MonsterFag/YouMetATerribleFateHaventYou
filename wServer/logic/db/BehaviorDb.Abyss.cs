            ...
            .Init(0x090a, Behaves("Archdemon Malphas",
                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(100, new LootDef(0, 5, 2, 8,
                        ...
                        Tuple.Create(0.03, (ILoot) new ItemLoot("Demon Blade")),
                        Tuple.Create(0.06, (ILoot)new ItemLoot("Sword of Illumination")),
                        Tuple.Create(0.15, (ILoot) new ItemLoot("Void Incantation")),
            ...
            .Init(0x0e1d, Behaves("Abyss Idol",
                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(100, new LootDef(0, 5, 0, 10,
                        ...
                        Tuple.Create(0.006, (ILoot)new ItemLoot("Sword of Illumination")),
