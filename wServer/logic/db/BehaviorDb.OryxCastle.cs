  ...
  partial class BehaviorDb
  {
    private static _ Castle = Behav() 
      ...
      //Tuple.Create(0.1, (ILoot) new TierLoot(3, ItemType.Misc)
        ...
        .Init(0x7150, Behaves("Bledi's Oryx Pet",
            new RunBehaviors(
              SimpleWandering.Instance(2, 2f),
              Chasing.Instance(9.5f, 16, 0, null),
              Cooldown.Instance(400, RingAttack.Instance(1, 2, projectileIndex: 0))
            ...
            loot: new LootBehavior(LootDef.Empty,
                Tuple.Create(100, new LootDef(0, 5, 0, 12,
            Tuple.Create(0.1, (ILoot)new ItemLoot("Cpt America Bow")),
            Tuple.Create(0.1, (ILoot)new ItemLoot("Original Mithril Sword")),
            Tuple.Create(0.1, (ILoot)new ItemLoot("Doku No Ken")),
            Tuple.Create(0.1, (ILoot)new ItemLoot("Dual Handed")),
            Tuple.Create(0.1, (ILoot)new ItemLoot("Gun")),
            Tuple.Create(0.1, (ILoot)new ItemLoot("Pickaxe")),
            Tuple.Create(0.1, (ILoot)new ItemLoot("RainBow")),
            Tuple.Create(0.1, (ILoot)new ItemLoot("Ancient Stone Axe")),
            Tuple.Create(0.1, (ILoot)new ItemLoot("Void Axe")),
            Tuple.Create(0.1, (ILoot)new ItemLoot("Molten Axe")),
            Tuple.Create(0.1, (ILoot)new ItemLoot("Ghost Axe")),
            Tuple.Create(0.1, (ILoot)new ItemLoot("Robe of the Dark Sky")),
            ...
            Tuple.Create(0.1, (ILoot)new ItemLoot("Sparschwein"))
            )))
        ))
