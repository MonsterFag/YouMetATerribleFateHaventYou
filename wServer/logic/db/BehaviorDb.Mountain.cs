...
namespace wServer.logic
{
    ...
    {
        private const double PotProbability = 0.1;

        private static readonly LootDef CommonGodSoulBag =
            new LootDef(0, 2, 0, 8,
                Tuple.Create(0.020, (ILoot) new TierLoot(9, ItemType.Weapon)),
                Tuple.Create(0.015, (ILoot) new TierLoot(10, ItemType.Weapon)),
                Tuple.Create(0.010, (ILoot) new TierLoot(11, ItemType.Weapon)),
                Tuple.Create(0.020, (ILoot) new TierLoot(10, ItemType.Armor)),
                Tuple.Create(0.015, (ILoot) new TierLoot(11, ItemType.Armor)),
                Tuple.Create(0.010, (ILoot) new TierLoot(12, ItemType.Armor)),
                Tuple.Create(0.015, (ILoot) new TierLoot(4, ItemType.Ring)),
                Tuple.Create(0.001, (ILoot) new TierLoot(5, ItemType.Ring)),
                Tuple.Create(0.030, (ILoot) new TierLoot(5, ItemType.Ability)),
				Tuple.Create(0.001, (ILoot)new ItemLoot("Bee Generator")),
				Tuple.Create(0.001, (ILoot)new ItemLoot("Black Cat Generator")),
				Tuple.Create(0.001, (ILoot)new ItemLoot("Golden Pup Generator")),
				Tuple.Create(0.001, (ILoot)new ItemLoot("Lion Generator")),
				Tuple.Create(0.001, (ILoot)new ItemLoot("Penguin Generator")),
				Tuple.Create(0.001, (ILoot)new ItemLoot("Panda Generator")),
				Tuple.Create(0.0001, (ILoot)new ItemLoot("Oldschool Dragonscale Armor")),
				Tuple.Create(0.001, (ILoot)new ItemLoot("Grey Cat Generator"))
                );
