...
namespace wServer.realm.entities.player
{
    public class Prices
    {
        ...
        public Prices()
        {
            ...
            AddPrice(100, "Agateclaw Dagger", "Staff of Astral Knowledge", "Skysplitter Sword",
                "Bow of Innocent Blood", "Wand of Ancient Warning", "Robe of the Elder Warlock", "Griffon Hide Armor",
                "Abyssal Armor");
            AddPrice(120, "Magic Nova Spell", "Tome of Divine Favor", "Golden Quiver", "Cloak of Endless Twilight",
            ...
            AddPrice(200, "Dagger of Foul Malevolence", "Staff of the Cosmic Whole", "Sword of Acclaim",
                "Wand of Recompense", "Bow of Covert Havens", "Robe of the Grand Sorcerer", "Hydra Skin Armor",
                "Acropolis Armor");
            AddPrice(200, "Elemental Detonation Spell", "Tome of Holy Guidance", "Quiver of Elvish Mastery",
            ...
            AddPrice(250, "Wine Cellar Incantation");
            AddPrice(500, "Dagger of Sinister Deeds", "Staff of the Vital Unity", "Sword of Splendor",
                "Wand of Evocation", "Bow of Mystical Energy", "Robe of the Star Mother", "Wyrmhide Armor",
                "Dominion Armor");
            AddPrice(500, "Souleater Skull", "Mobstopper Trap", "Cloak of Dimensions", "Bloodorc Quiver",
            ...
            AddPrice(600, "Dagger of Dire Hatred", "Staff of the Fundamental Core", "Sword of Majesty",
                "Wand of Retribution", "Bow of Deep Enchantment", "Robe of the Ancient Intellect", "Leviathan Armor",
                "Annihilation Armor");
            AddPrice(600, "Skull of the Undead King", "Azure Trap", "Cloak of the Phantom", "Quiver of Artemis",
            ...
            AddPrice(1000, "Crystal Sword", "Crystal Wand", "Crystal Dagger", "Coral Bow", "Forge Amulet",
                "Ring of the Pyramid", "Ring of the Nile", "Ring of the Sphinx", "Spectral Cloth Armor",
                "Captain's Ring");
            AddPrice(750, "Staff of Extreme Prejudice", "Wand of the Bulwark", "Anatis Staff", "Orb of the Chaos Walker",
                "Prism of Inception", "Tome of Holy Protection", "Tome of Noble Assault", "Scepter of Thunderclash");
            AddPrice(500, "Spirit Dagger", "Ghostly Prism");
            AddPrice(750, "Chicken Leg of Doom");
            AddPrice(2000, "Doom Bow", "Demon Blade", "Platinum Sword", "Platinum Wand", "Miasma Poison",
                "Shield of Ogmur");
