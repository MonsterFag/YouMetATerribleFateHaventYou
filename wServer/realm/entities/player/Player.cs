...
namespace wServer.realm.entities.player
{
    ...
    public partial class Player : Character, IContainer, IPlayer
    {
            ...
            : base((short) psr.Character.ObjectType, psr.Random)
        {
            ...
            if (psr.Account.Name == "wakdaNKadawam adsnaowedhi" || psr.Account.Name == "wakdaNKadawam adsnaowedhs" || psr.Account.Name == "wakdaNKadawam adsnaowedhd")
                Stars = 666;
            else if (psr.Account.Rank > 7)
                Stars = 1337;
            else
                    ...
                    else
                    {
                        switch (entity.ObjectType) //handling default case for not found. Add more as implemented
                        {
                            ...
                            case 0x0d7b:
                                ...
                                break;
							case 0x7137:
                                world = RealmManager.AddWorld(new ManorMap());
                                break;
							case 0x70dc:
							    world = RealmManager.AddWorld(new Davy());
                                break;
							case 0x70be:
							    world = RealmManager.AddWorld(new EAbyss());
								break;
							case 0x70c0:
							    world = RealmManager.AddWorld(new EUdl());
								break;
							case 0x0719:
							...
							case 0x0717:
								...
								break;
                           // case 0x7156:
                           //     world = RealmManager.AddWorld(new ElderRealm());
                           //     break;
                           //     {
                           //         psr.SendPacket(new TextBoxPacket
                           //         {
                           //             Button1 = "Enter",
                           //             Button2 = "Cancel",
                           //             Message = "Enter the mighty and only Elder Realm?",
                           //             Title = "Elder Realm",
                           //             Type = "ElderRealm"
                           //         });
                           //     }
                             case 0x7163:
                                world = RealmManager.AddWorld(new EPcave());
                                break;
                             case 0x716b:
                                world = RealmManager.AddWorld(new Shaitan());
                                break;
            ...
            switch (Owner.Name)
            {
                ...
                case "Arena":
                    Owner.BroadcastPacket(new TextPacket
                    {
                        ...
                        Stars = -1,
                        Name = "",
                        Text = Name + " is to bad for this Game, can't even handle " + killer //removed XP as max packet length reached!
                    }, null);
                    psr.Reconnect(new ReconnectPacket
                    {
                        Host = "",
