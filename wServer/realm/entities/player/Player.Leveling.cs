    ...
    public partial class Player
    {
        private static readonly Dictionary<string, Tuple<int, int, int>> QuestDat =
            new Dictionary<string, Tuple<int, int, int>> //Priority, Min, Max
            {
                ...
                {"Wasp Queen", Tuple.Create(8, 7, 500)},
                {"Horned Drake", Tuple.Create(8, 7, 500)},
                {"Deathmage", Tuple.Create(5, 6, 11)},
                {"Great Coil Snake", Tuple.Create(6, 6, 12)},
                {"Lich", Tuple.Create(9, 6, 500)},
                {"Actual Lich", Tuple.Create(9, 7, 500)},
                {"Ent Ancient", Tuple.Create(10, 7, 500)},
                {"Actual Ent Ancient", Tuple.Create(10, 7, 500)},
                {"Oasis Giant", Tuple.Create(11, 8, 500)},
                {"Phoenix Lord", Tuple.Create(11, 9, 500)},
                {"Ghost King", Tuple.Create(12, 10, 500)},
                {"Actual Ghost King", Tuple.Create(12, 10, 500)},
                {"Cyclops God", Tuple.Create(13, 10, 500)},
                {"Red Demon", Tuple.Create(15, 15, 500)},
                {"Skull Shrine", Tuple.Create(16, 15, 500)},
                {"Phoenix God", Tuple.Create(16, 15, 500)},
                {"Pentaract", Tuple.Create(16, 15, 500)},
                {"Cube God", Tuple.Create(16, 15, 500)},
                {"Grand Sphinx", Tuple.Create(16, 15, 500)},
                {"Lord of the Lost Lands", Tuple.Create(16, 15, 500)},
                {"Hermit God", Tuple.Create(16, 15, 500)},
                {"Ghost Ship", Tuple.Create(16, 15, 500)},
                {"Unknown Giant Golem", Tuple.Create(16, 15, 500)},
                {"Evil Chicken God", Tuple.Create(20, 1, 500)},
                {"Bonegrind The Butcher", Tuple.Create(20, 1, 500)},
                {"Dreadstump the Pirate King", Tuple.Create(20, 1, 500)},
                {"Arachna the Spider Queen", Tuple.Create(20, 1, 500)},
                {"Stheno the Snake Queen", Tuple.Create(20, 1, 500)},
                {"Mixcoatl the Masked God", Tuple.Create(20, 1, 500)},
                {"Limon the Sprite God", Tuple.Create(20, 1, 500)},
                {"Septavius the Ghost God", Tuple.Create(20, 1, 500)},
                {"Davy Jones", Tuple.Create(20, 1, 500)},
                {"Lord Ruthven", Tuple.Create(20, 1, 500)},
                {"Archdemon Malphas", Tuple.Create(20, 1, 500)},
                {"Elder Tree", Tuple.Create(20, 1, 500)},
                {"Thessal the Mermaid Goddess", Tuple.Create(20, 1, 500)},
                {"Dr. Terrible", Tuple.Create(20, 1, 500)},
                {"Horrific Creation", Tuple.Create(20, 1, 500)},
                {"Masked Party God", Tuple.Create(20, 1, 500)},
                {"Stone Guardian Left", Tuple.Create(20, 1, 500)},
                {"Stone Guardian Right", Tuple.Create(20, 1, 500)},
                {"Oryx the Mad God 1", Tuple.Create(20, 1, 500)},
                {"Oryx the Mad God 2", Tuple.Create(20, 1, 500)},
                {"Oryx the Mad God 3", Tuple.Create(20, 1, 500)},
            };
        ...
        private Entity FindQuest()
        {
            ...
            try
            {
                    ...
                    .OrderBy(quest => MathsUtils.DistSqr(quest.X, quest.Y, X, Y)))
                {
                    ...
                    {
                        var score = (220 - Math.Abs((i.ObjectDesc.Level ?? 0) - Level))*x.Item1 -
                                      //priority * level diff
            ...
            if (Experience - GetLevelExp(Level) >= ExperienceGoal && Level < 120)
            {
                ...
                if (Level == 120)
                    foreach (var i in Owner.Players.Values)
                        i.SendInfo(Name + " Is now able to join Elder Realms!");
                questEntity = null;
                return true;
            }
            CalculateFame();
